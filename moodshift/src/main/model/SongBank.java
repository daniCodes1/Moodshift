...
public class SongBank {
    ...
    private void addAllHappy() {
        songDatabase.add(new Song("Hello", "Adele", 2015, "happy", "bored"));
        ...
        songDatabase.add(new Song("Best Day Of My Life", "American Authors",
                2013, "happy", "bored"));
        songDatabase.add(new Song("Riptide", "Vance Joy",2013, "happy", "bored"));
        ...
        songDatabase.add(new Song("Love Story", "Taylor Swift",
                2008, "happy", "nervous"));
        songDatabase.add(new Song("My Love", "Westlife", 2000, "happy", "nervous"));
        songDatabase.add(new Song("Paradise", "Coldplay", 2009, "happy", "nervous"));

        songDatabase.add(new Song("I Want It That Way", "Backstreet Boys",
                1999, "happy", "excited"));
        songDatabase.add(new Song("Wannabe", "Spice Girls", 1996, "happy", "excited"));
...
//                1987, "pop", "pre-1990"));
    ...
    private void addAllSad() {
        ...
        songDatabase.add(new Song("Heathens", "twenty one pilots",
                2016, "sad", "excited"));
        songDatabase.add(new Song("Pompeii", "Bastille", 2013, "sad", "excited"));
        songDatabase.add(new Song("Shut Up and Dance", "WALK THE MOON",
                2014, "sad", "excited"));
    }

    private void addAllAngry() {
        // rock 2000-2009
        songDatabase.add(new Song("Kryptonite", "3 Doors Down",
                2000, "angry", "bored"));
        songDatabase.add(new Song("Jaded", "Aerosmith", 2001, "angry", "bored"));
        songDatabase.add(new Song("Snow (Hey Oh)", "Red Hot Chili Peppers",
                2006, "angry", "bored"));

        // rock 1990-1999
        songDatabase.add(new Song("Basket Case", "Green Day", 1994, "angry", "bored"));
        songDatabase.add(new Song("One", "U2", 1992, "angry", "bored"));
        songDatabase.add(new Song("Wonderwall", "Oasis", 1995, "angry", "bored"));
...
//    }
    ...
    public void applyFilters(String emotion1, String emotion2) {
        for (Song s: songDatabase) {
            if ((emotion1.equals(s.getEmotion1())) && (emotion2.equals(s.getReleasePeriod()))) {
